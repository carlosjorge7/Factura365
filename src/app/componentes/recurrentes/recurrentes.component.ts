...
@Component({
  ...
  styleUrls: ['./recurrentes.component.css']
})
export class RecurrentesComponent implements OnInit {
  ...
  flagger(){
    ...
    this.facturasService.setFlagger('0');
  ...
  exportAsXLSX():void {
    ...
    this.exporterService.exportAsExcelFile(this.dataFacturas, 'facturas');
  }
